...
async function checkIfSignedIn() {
    const savedToken = localStorage.getItem('google_drive_token_chinese');
    ...
    if (savedToken) {
        try {
            ...
            if (tokenObj.expiry && now < tokenObj.expiry) {
                ...
                localStorage.removeItem('google_drive_token_chinese');
            }
        } catch (error) {
...
function saveTokenToStorage(token) {
    ...
    localStorage.setItem('google_drive_token_chinese', JSON.stringify(tokenWithExpiry));
}
